...
SWEP.ViewModel			= "models/krazy/mw3/stinger_v.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/krazy/mw3/stinger_w.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(0.17, -4.581, 1.97)
SWEP.IronSightsAng = Vector(7.296, -21.063, 32.263)
...
function SWEP:Think()
	...
	if self.StripTimer < CurTime() then
		self.Dispose = true
		if SERVER then
			self.Owner:StripWeapon("mw3_fim92stinger")
		end
	end
end
