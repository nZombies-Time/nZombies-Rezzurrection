...
--[Model]--
SWEP.ViewModel = "models/nzr/2023/syrette/c_syrette_bo4.mdl"
...
{ ["time"] = 0, ["type"] = "lua", value = function(self)
	if self:GetOwner():HasPerk("revive") then
		self.SequenceRateOverride[ACT_VM_DRAW] = 60 / 40
	else
		self.SequenceRateOverride[ACT_VM_DRAW] = 40 / 40
	end
end, client = true, server = true},
{ ["time"] = 0, ["type"] = "lua", value = function(self) self:GetOwner():SetUsingSpecialWeapon(true) end, client = false, server = true},
{ ["time"] = 20 / 40, ["type"] = "sound", ["value"] = Sound("NZ.Syrette.Open") },
{ ["time"] = 85 / 40, ["type"] = "sound", ["value"] = Sound("NZ.Syrette.Stab") },
},
}
