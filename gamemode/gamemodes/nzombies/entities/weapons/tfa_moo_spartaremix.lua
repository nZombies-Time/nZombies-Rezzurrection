...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_gladius_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_gladius_wm.mdl"
SWEP.HoldType = "melee"
...
SWEP.EventTable = {
	["h1_wpn_melee_gladius_inspect"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.melee_gladius_ins_01"},
		{time = 15 / 30, type = "sound", value = "yurie_h1.melee_gladius_ins_02"},
		{time = 63 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 78 / 30, type = "sound", value = "yurie_h1.melee_gladius_ins_03"},
	},
	["h1_wpn_melee_gladius_pullout_first"] = {
		{time = 25 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 0 / 30, type = "sound", value = "yurie_h1.melee_gladius_pullout_first_01"},
		{time = 9 / 30, type = "sound", value = "yurie_h1.melee_gladius_pullout_first_02"},
	},
	["h1_wpn_melee_gladius_putaway"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.melee_gladius_putaway"},
	},
	["h1_wpn_melee_gladius_stab"] = {
		{time = 5 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_gladius_swipe"] = {
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_gladius")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_gladius", "vgui/killicons/tfa_mwr_gladius", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.melee_gladius_","weapons/tfa_cod/mwr/h1_dlc_wpn/gladius/melee_gladius_"
