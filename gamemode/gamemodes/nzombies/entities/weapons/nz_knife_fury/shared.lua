...
SWEP.PrintName = "Fury's Song"
SWEP.Author		= "Laby" --Author Tooltip
SWEP.ViewModel = "models/weapons/bo3_melees/sword/c_sword_nz.mdl"
SWEP.WorldModel = "models/weapons/bo3_melees/sword/w_sword.mdl"
...
SWEP.Primary.Attacks = {
	{
		...
		['dmg'] = 340, --This isn't overpowered enough, I swear!!
