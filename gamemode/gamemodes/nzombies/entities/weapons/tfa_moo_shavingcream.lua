...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_razor_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_razor_wm.mdl"
SWEP.HoldType = "knife"
...
SWEP.EventTable = {
	["h1_wpn_melee_razor_inspect"] = {
		{time = 2 / 30, type = "sound", value = "yurie_h1.razr_ins_01"},
		{time = 26 / 30, type = "sound", value = "yurie_h1.razr_ins_02"},
		{time = 27 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 44 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 89 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 104 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 64 / 30, type = "sound", value = "yurie_h1.razr_ins_03"},
		{time = 129 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
	},
	["h1_wpn_melee_razor_pullout"] = {
		{time = 4 / 30, type = "sound", value = "yurie_h1.razr_pullout"},
		{time = 7 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
	},
	["h1_wpn_melee_razor_pullout_first"] = {
		{time = 3 / 30, type = "sound", value = "yurie_h1.razr_pullout_first_01"},
		{time = 4 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 21 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 33 / 30, type = "sound", value = "yurie_h1.razr_pullout_first_02"},
	},
	["h1_wpn_melee_razor_putaway"] = {
		{time = 8 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 5 / 30, type = "sound", value = "yurie_h1.razr_putaway"},
	},
	["h1_wpn_melee_razor_sprint_in"] = {
		{time = 3 / 30, type = "sound", value = "yurie_h1.razr_sprintin"},
		{time = 7 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_razor_sprint_out"] = {
		{time = 1 / 30, type = "sound", value = "yurie_h1.razr_sprintout"},
		{time = 6 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_razor_stab"] = {
		{time = 2 / 30, type = "sound", value = "yurie_h1.razr_stab_01"},
		{time = 33 / 30, type = "sound", value = "yurie_h1.razr_stab_03"},
		{time = 5 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 15 / 30, type = "sound", value = "yurie_h1.razr_stab_02"},
		{time = 20 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 34 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_razor_swipe"] = {
		{time = 4 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 3 / 30, type = "sound", value = "yurie_h1.razr_swipe"},
	},
}
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_razor")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_razor", "vgui/killicons/tfa_mwr_razor", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.razr_","weapons/tfa_cod/mwr/h1_dlc_wpn/melee_razr/h1_wpn_melee_razr_"
	...
	TFA.AddSound(p1.."pullout", CHAN_STATIC, 1, 75, 100, p2.."pout.ogg", ")")
	TFA.AddSound(p1.."pullout_first_01", CHAN_STATIC, 1, 75, 100, p2.."pout_1st_01.ogg", ")")
	TFA.AddSound(p1.."pullout_first_02", CHAN_STATIC, 1, 75, 100, p2.."pout_1st_02.ogg", ")")
	TFA.AddSound(p1.."putaway", CHAN_STATIC, 1, 75, 100, p2.."putaway.ogg", ")")
	TFA.AddSound(p1.."sprintin", CHAN_STATIC, 1, 75, 100, p2.."sprintin.ogg", ")")
	TFA.AddSound(p1.."sprintout", CHAN_STATIC, 1, 75, 100, p2.."sprintout.ogg", ")")
	TFA.AddSound(p1.."stab_01", CHAN_STATIC, 1, 75, 100, p2.."stab_01.ogg", ")")
	TFA.AddSound(p1.."stab_02", CHAN_STATIC, 1, 75, 100, p2.."stab_02.ogg", ")")
	TFA.AddSound(p1.."stab_03", CHAN_STATIC, 1, 75, 100, p2.."stab_03.ogg", ")")
