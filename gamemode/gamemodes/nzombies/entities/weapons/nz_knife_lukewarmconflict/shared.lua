...
SWEP.PrintName = "Jungle Knife"
SWEP.Author		= "Laby" --Author Tooltip
SWEP.ViewModel = "models/weapons/bo3_melees/cwknife/c_cwknife_nz.mdl"
SWEP.WorldModel = "models/weapons/bo3_melees/cwknife/w_cwknife.mdl"
