...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_cleaver_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_cleaver_wm.mdl"
SWEP.HoldType = "knife"
...
SWEP.EventTable = {
	["h1_wpn_melee_cleaver_inspect"] = {
		{time = 2 / 30, type = "sound", value = "yurie_h1.clvr_ins_02"},
		{time = 58 / 30, type = "sound", value = "yurie_h1.clvr_ins_01"},
		{time = 63 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 72 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_cleaver_pullout"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.hammer_pullout"},
		{time = 11 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_cleaver_pullout_first"] = {
		{time = 6 / 30, type = "sound", value = "yurie_h1.clvr_pullout_first"},
		{time = 31 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
	},
	["h1_wpn_melee_cleaver_putaway"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.hammer_putaway"},
		{time = 7 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
	},
	["h1_wpn_melee_cleaver_stab"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.clvr_stab"},
		{time = 5 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_cleaver_swipe"] = {
		{time = 1 / 30, type = "sound", value = "yurie_h1.clvr_swipe"},
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_cleaver")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_cleaver", "vgui/killicons/tfa_mwr_cleaver", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.clvr_","weapons/tfa_cod/mwr/h1_dlc_wpn/melee_clvr/h1_wpn_melee_clvr_"
