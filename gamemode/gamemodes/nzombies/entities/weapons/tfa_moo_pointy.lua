...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_tactical_knife_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_tactical_knife_wm.mdl"
SWEP.HoldType = "knife"
...
SWEP.EventTable = {
	...
	["h1_wpn_melee_point_knife_inspect"] = {
		{time = 4 / 30, type = "sound", value = "yurie_h1.pknf_ins_01"},
		{time = 28 / 30, type = "sound", value = "yurie_h1.pknf_ins_02"},
		{time = 46 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 55 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 83 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 116 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 73 / 30, type = "sound", value = "yurie_h1.pknf_ins_03"},
		{time = 110 / 30, type = "sound", value = "yurie_h1.pknf_ins_04"},
	},
	["h1_wpn_melee_point_knife_pullout_first"] = {
		{time = 16 / 60, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 61 / 60, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 17 / 60, type = "sound", value = "yurie_h1.pknf_pout_1st"},
	},
}
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_tactical_knife")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_tactical_knife", "vgui/killicons/tfa_mwr_tactical_knife", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.pknf_","weapons/tfa_cod/mwr/h1_dlc_wpn/melee_pknf/h1_wpn_melee_pknf_"
	...
	TFA.AddSound(p1.."pout_1st", CHAN_STATIC, 1, 75, 100, p2.."pullout_1st.ogg", ")")
end
