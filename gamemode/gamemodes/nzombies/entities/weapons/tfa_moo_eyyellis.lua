...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_wrench_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_wrench_wm.mdl"
SWEP.HoldType = "melee"
...
SWEP.EventTable = {
	["h1_wpn_melee_tac_wrench_inspect"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.mechanic_ins_01"},
		{time = 25 / 30, type = "sound", value = "yurie_h1.mechanic_ins_02"},
		{time = 62 / 30, type = "sound", value = "yurie_h1.mechanic_ins_03"},
		{time = 64 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
		{time = 77 / 30, type = "sound", value = "yurie_h1.mechanic_ins_04"},
		{time = 100 / 30, type = "sound", value = "yurie_h1.mechanic_ins_05"},
		{time = 79 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
	},
	["h1_wpn_melee_tac_wrench_pullout_first"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.mechanic_pulloutfirst_01"},
		{time = 27 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 26 / 30, type = "sound", value = "yurie_h1.mechanic_pulloutfirst_02"},
	},
	["h1_wpn_melee_tac_wrench_putaway"] = {
		{time = 10 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_tac_wrench_stab"] = {
		{time = 5 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_tac_wrench_swipe"] = {
		{time = 6 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
	},
	["h1_wpn_melee_tac_wrenchl_pullout"] = {
		{time = 9 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
}
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_wrench")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_wrench", "vgui/killicons/tfa_mwr_wrench", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.mechanic_","weapons/tfa_cod/mwr/h1_dlc_wpn/melee_mechanic/mechanic_"
