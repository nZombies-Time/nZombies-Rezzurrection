...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_knuckle_knife_irish_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_knuckle_knife_irish_wm.mdl"
SWEP.HoldType = "knife"
...
SWEP.EventTable = {
	["h1_wpn_melee_knuckle_knife_inspect"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.shamrock_ins_01"},
		{time = 49 / 30, type = "sound", value = "yurie_h1.shamrock_ins_02"},
		{time = 102 / 30, type = "sound", value = "yurie_h1.shamrock_ins_03"},
		{time = 154 / 30, type = "sound", value = "yurie_h1.shamrock_ins_04"},
	},
	["h1_wpn_melee_knuckle_knife_pullout"] = {
		{time = 2 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_knuckle_knife_pullout_first"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.shamrock_pulloutfirst_01"},
		{time = 8 / 30, type = "sound", value = "yurie_h1.shamrock_pulloutfirst_02"},
		{time = 22 / 30, type = "sound", value = "yurie_h1.shamrock_pulloutfirst_03"},
		{time = 11 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 28 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_knuckle_knife_putaway"] = {
		{time = 11 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_knuckle_knife_stab"] = {
		{time = 5 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_knuckle_knife_swipe"] = {
