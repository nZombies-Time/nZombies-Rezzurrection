...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_trucker_tool_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_trucker_tool_wm.mdl"
SWEP.HoldType = "melee"
...
SWEP.EventTable = {
	["h1_wpn_melee_truckers_tool_inspect"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.thug_ins_01"},
		{time = 11 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 21 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 33 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 89 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 30 / 30, type = "sound", value = "yurie_h1.thug_ins_02"},
		{time = 49 / 30, type = "sound", value = "yurie_h1.thug_ins_03"},
		{time = 51 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 81 / 30, type = "sound", value = "yurie_h1.thug_ins_04"},
	},
	["h1_wpn_melee_truckers_tool_pullout"] = {
		{time = 10 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_truckers_tool_pullout_first"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.thug_pulloutfirst_01"},
		{time = 20 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 15 / 30, type = "sound", value = "yurie_h1.thug_pulloutfirst_02"},
	},
	["h1_wpn_melee_truckers_tool_putaway"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.melee_putaway"},
	},
	["h1_wpn_melee_truckers_tool_stab"] = {
	...
	["h1_wpn_melee_truckers_tool_swipe"] = {
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_trucker_tool")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_trucker_tool", "vgui/killicons/tfa_mwr_trucker_tool", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.thug_","weapons/tfa_cod/mwr/h1_dlc_wpn/melee_thug/thug_"
