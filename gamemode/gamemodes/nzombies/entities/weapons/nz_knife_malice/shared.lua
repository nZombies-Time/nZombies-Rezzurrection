...
SWEP.ViewModel = "models/weapons/bo3_melees/dagger/c_dagger_nz.mdl"
SWEP.WorldModel = "models/weapons/bo3_melees/dagger/w_dagger.mdl"
...
SWEP.Primary.Attacks = {
	{
		...
		["hull"] = 1, --Hullsize
		['hitflesh'] = "Weapon_BO3_DAGGER.Hit_Flesh",
