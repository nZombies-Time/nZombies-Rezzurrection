...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_shilellagh_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_shilellagh_wm.mdl"
SWEP.HoldType = "melee"
...
SWEP.EventTable = {
	["h1_wpn_melee_shillelagh_inspect"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.stick_ins_01"},
		{time = 43 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 98 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 51 / 30, type = "sound", value = "yurie_h1.stick_ins_02"},
		{time = 75 / 30, type = "sound", value = "yurie_h1.stick_ins_03"},
		{time = 61 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 97 / 30, type = "sound", value = "yurie_h1.stick_ins_04"},
	},
	["h1_wpn_melee_shillelagh_pullout"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.shovel_pullout"},
		{time = 11 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_shillelagh_pullout_first"] = {
		{time = 28 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 0 / 30, type = "sound", value = "yurie_h1.stick_pulloutfirst_01"},
		{time = 6 / 30, type = "sound", value = "yurie_h1.stick_pulloutfirst_02"},
		{time = 29 / 30, type = "sound", value = "yurie_h1.stick_pulloutfirst_03"},
	},
	["h1_wpn_melee_shillelagh_putaway"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.shovel_putaway"},
		{time = 10 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_shillelagh_stab"] = {
		{time = 5 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_shillelagh_swipe"] = {
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_shilellagh")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_shilellagh", "vgui/killicons/tfa_mwr_shilellagh", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.stick_","weapons/tfa_cod/mwr/h1_dlc_wpn/melee_stick/stick_"
