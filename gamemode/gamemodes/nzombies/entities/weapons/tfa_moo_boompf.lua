...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_hammer_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_hammer_wm.mdl"
SWEP.HoldType = "melee"
...
SWEP.EventTable = {
	["h1_wpn_melee_russian_hammer_inspect"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.hammer_inspect_1"},
		{time = 16 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 39 / 30, type = "sound", value = "yurie_h1.hammer_inspect_2"},
		{time = 52 / 30, type = "sound", value = "yurie_h1.hammer_inspect_3"},
		{time = 55 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 67 / 30, type = "sound", value = "yurie_h1.hammer_inspect_4"},
	},
	["h1_wpn_melee_russian_hammer_pullout"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.hammer_pullout"},
		{time = 11 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_russian_hammer_pullout_first"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.hammer_pullout_first"},
		{time = 20 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_russian_hammer_putaway"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.hammer_putaway"},
		{time = 7 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
	},
	["h1_wpn_melee_russian_hammer_stab"] = {
		{time = 6 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_russian_hammer_swipe"] = {
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_hammer")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_hammer", "vgui/killicons/tfa_mwr_hammer", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.hammer_","weapons/tfa_cod/mwr/h1_dlc_wpn/hammer/hammer_"
	...
	TFA.AddSound(p1.."inspect_4", CHAN_STATIC, 1, 75, 100, p2.."inspect_4.ogg", ")")
	TFA.AddSound(p1.."pullout", CHAN_STATIC, 1, 75, 100, p2.."pullout.ogg", ")")
	TFA.AddSound(p1.."pullout_first", CHAN_STATIC, 1, 75, 100, p2.."pullout_first.ogg", ")")
