...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_karambit_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_karambit_wm.mdl"
SWEP.HoldType = "knife"
...
SWEP.EventTable = {
	["h1_wpn_melee_karambit_inspect"] = {
		{time = 37 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 56 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 72 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 86 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 99 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 107 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 122 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 46 / 30, type = "sound", value = "yurie_h1.karambit_ins_01"},
		{time = 91 / 30, type = "sound", value = "yurie_h1.karambit_ins_02"},
	},
	["h1_wpn_melee_karambit_pullout"] = {
		{time = 3 / 30, type = "sound", value = "yurie_h1.karambit_pullout"},
		{time = 8 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_karambit_pullout_first"] = {
		{time = 7 / 30, type = "sound", value = "yurie_h1.karambit_pullout_first"},
		{time = 23 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_karambit_putaway"] = {
		{time = 4 / 30, type = "sound", value = "yurie_h1.karambit_putaway"},
		{time = 12 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_karambit_stab"] = {
		{time = 5 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
		{time = 19 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_karambit_swipe"] = {
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_karambit")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_karambit", "vgui/killicons/tfa_mwr_karambit", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.karambit_","weapons/tfa_cod/mwr/h1_dlc_wpn/melee_karambit/h1_wpn_melee_karambit_"
