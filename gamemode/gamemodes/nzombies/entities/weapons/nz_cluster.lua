...
SWEP.ViewModel				= "models/nz_equipment/v_nam_geballteladung.mdl"
...
function SWEP:ThrowGrenade(force)
	...
	if SERVER then
		local nade = ents.Create("nz_nam_geballte_ladung")
