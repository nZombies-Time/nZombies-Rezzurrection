...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_rifle_bayonet_vm.mdl"
...
SWEP.EventTable = {
	["h1_wpn_melee_bayonet_knife_inspect"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.b_knife_inspect_1"},
		{time = 143 / 30, type = "sound", value = "yurie_h1.b_knife_inspect_3"},
		{time = 39 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 92 / 30, type = "sound", value = "yurie_h1.b_knife_inspect_2"},
	},
	["h1_wpn_melee_bayonet_knife_pullout"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.b_knife_pullout_quick"},
		{time = 2 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_bayonet_knife_pullout_first"] = {
		{time = 1 / 30, type = "sound", value = "yurie_h1.b_knife_pullout_first_1"},
		{time = 11 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 27 / 30, type = "sound", value = "yurie_h1.b_knife_pullout_first_2"},
		{time = 28 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_bayonet_knife_putaway"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.b_knife_putaway"},
		{time = 11 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_bayonet_knife_stab"] = {
		{time = 5 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_bayonet_knife_swipe"] = {
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_rifle_bayonet")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_rifle_bayonet", "vgui/killicons/tfa_mwr_rifle_bayonet", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.b_knife_","weapons/tfa_cod/mwr/h1_dlc_wpn/bayonet/b_knife_"
	TFA.AddSound(p1.."inspect_1", CHAN_STATIC, 1, 75, 100, p2.."inspect_1.ogg", ")")
	TFA.AddSound(p1.."inspect_2", CHAN_STATIC, 1, 75, 100, p2.."inspect_2.ogg", ")")
	TFA.AddSound(p1.."inspect_3", CHAN_STATIC, 1, 75, 100, p2.."inspect_3.ogg", ")")
	TFA.AddSound(p1.."pullout_first_1", CHAN_STATIC, 1, 75, 100, p2.."pullout_first_1.ogg", ")")
	TFA.AddSound(p1.."pullout_first_2", CHAN_STATIC, 1, 75, 100, p2.."pullout_first_2.ogg", ")")
	TFA.AddSound(p1.."putaway", CHAN_STATIC, 1, 75, 100, p2.."putaway.ogg", ")")
	TFA.AddSound(p1.."stab", CHAN_STATIC, 1, 75, 100, {p2.."stab_1.ogg",p2.."stab_2.ogg",p2.."stab_3.ogg"}, ")")
	TFA.AddSound(p1.."swipe", CHAN_STATIC, 1, 75, 100, {p2.."swipe_1.ogg",p2.."swipe_2.ogg",p2.."swipe_3.ogg",p2.."swipe_4.ogg",p2.."swipe_5.ogg"}, ")")
end
