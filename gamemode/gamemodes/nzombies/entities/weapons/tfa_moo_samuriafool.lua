...
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_katana_wm.mdl"
SWEP.HoldType = "melee"
...
SWEP.EventTable = {
	["h1_wpn_melee_katana_inspect"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.samurai_ins_01"},
		{time = 14 / 30, type = "sound", value = "yurie_h1.samurai_ins_02"},
		{time = 24 / 30, type = "sound", value = "yurie_h1.samurai_ins_03"},
	},
	["h1_wpn_melee_katana_pullout"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.katana_pullout"},
		{time = 6 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_katana_pullout_first"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.samurai_pulloutfirst_01"},
		{time = 6 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 20 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 45 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 11 / 30, type = "sound", value = "yurie_h1.samurai_pulloutfirst_02"},
		{time = 29 / 30, type = "sound", value = "yurie_h1.samurai_pulloutfirst_03"},
		{time = 32 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
	},
	["h1_wpn_melee_katana_putaway"] = {
		{time = 7 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 0 / 30, type = "sound", value = "yurie_h1.katana_putaway"},
	},
	["h1_wpn_melee_katana_stab"] = {
		{time = 5 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_katana_swipe"] = {
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_katana")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_katana", "vgui/killicons/tfa_mwr_katana", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.samurai_","weapons/tfa_cod/mwr/h1_dlc_wpn/melee_samurai/samurai_"
