...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_hatchet_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_hatchet_wm.mdl"
SWEP.HoldType = "melee"
...
SWEP.EventTable = {
	["h1_wpn_melee_hatchet_inspect"] = {
		{time = 8 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 22 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 27 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 35 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 43 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 86 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 0 / 30, type = "sound", value = "yurie_h1.melee_hatchet_ins_01"},
		{time = 23 / 30, type = "sound", value = "yurie_h1.melee_hatchet_ins_02"},
		{time = 34 / 30, type = "sound", value = "yurie_h1.melee_hatchet_ins_03"},
		{time = 45 / 30, type = "sound", value = "yurie_h1.melee_hatchet_ins_04"},
		{time = 60 / 30, type = "sound", value = "yurie_h1.melee_hatchet_ins_05"},
		{time = 73 / 30, type = "sound", value = "yurie_h1.melee_hatchet_ins_06"},
		{time = 61 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
	},
	["h1_wpn_melee_hatchet_pullout"] = {
		{time = 10 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_hatchet_pullout_first"] = {
		{time = 28 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 0 / 30, type = "sound", value = "yurie_h1.melee_hatchet_pullout_first_01"},
		{time = 15 / 30, type = "sound", value = "yurie_h1.melee_hatchet_pullout_first_02"},
	},
	["h1_wpn_melee_hatchet_putaway"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.melee_putaway"},
	},
	["h1_wpn_melee_hatchet_stab"] = {
		{time = 6 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 17 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 24 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_hatchet_swipe"] = {
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_hatchet")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_hatchet", "vgui/killicons/tfa_mwr_hatchet", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.melee_hatchet_","weapons/tfa_cod/mwr/h1_dlc_wpn/hatchet/melee_hatchet_"
	TFA.AddSound(p1.."ins_01", CHAN_STATIC, 1, 75, 100, p2.."ins_01.ogg", ")")
	TFA.AddSound(p1.."ins_02", CHAN_STATIC, 1, 75, 100, p2.."ins_02.ogg", ")")
	TFA.AddSound(p1.."ins_06", CHAN_STATIC, 1, 75, 100, p2.."ins_06.ogg", ")")
	TFA.AddSound(p1.."pullout_first_01", CHAN_STATIC, 1, 75, 100, p2.."pullout_first_01.ogg", ")")
	TFA.AddSound(p1.."pullout_first_02", CHAN_STATIC, 1, 75, 100, p2.."pullout_first_02.ogg", ")")
end
