...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_staff_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_staff_wm.mdl"
SWEP.HoldType = "melee"
...
SWEP.EventTable = {
	["h1_wpn_melee_tribal_staff_inspect"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.tribal_ins_01"},
		{time = 36 / 30, type = "sound", value = "yurie_h1.tribal_ins_02"},
	},
	["h1_wpn_melee_tribal_staff_pullout"] = {
		{time = 10 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_tribal_staff_pullout_first"] = {
		{time = 6 / 30, type = "sound", value = "yurie_h1.tribal_pullout_first_01"},
		{time = 10 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 40 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 25 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 35 / 30, type = "sound", value = "yurie_h1.tribal_pullout_first_02"},
	},
	["h1_wpn_melee_tribal_staff_putaway"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.melee_putaway"},
	},
	["h1_wpn_melee_tribal_staff_stab"] = {
	...
	["h1_wpn_melee_tribal_staff_swipe"] = {
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_staff")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_staff", "vgui/killicons/tfa_mwr_staff", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.tribal_","weapons/tfa_cod/mwr/h1_dlc_wpn/melee_tribal/h1_wpn_melee_tribal_"
	TFA.AddSound(p1.."ins_01", CHAN_STATIC, 1, 75, 100, p2.."ins_01.ogg", ")")
	TFA.AddSound(p1.."ins_02", CHAN_STATIC, 1, 75, 100, p2.."ins_02.ogg", ")")
	TFA.AddSound(p1.."pullout_first_01", CHAN_STATIC, 1, 75, 100, p2.."pout1st_01.ogg", ")")
	TFA.AddSound(p1.."pullout_first_02", CHAN_STATIC, 1, 75, 100, p2.."pout1st_02.ogg", ")")
end
