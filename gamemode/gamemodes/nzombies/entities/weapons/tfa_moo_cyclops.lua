...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_harpoon_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_harpoon_wm.mdl"
SWEP.HoldType = "knife"
...
SWEP.EventTable = {
	["h1_wpn_melee_harpoon_inspect"] = {
		{time = 11 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 52 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 12 / 30, type = "sound", value = "yurie_h1.hrpn_ins_01"},
		{time = 20 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 123 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 90 / 30, type = "sound", value = "yurie_h1.hrpn_ins_02"},
	},
	["h1_wpn_melee_harpoon_pullout"] = {
		{time = 4 / 30, type = "sound", value = "yurie_h1.hrpn_pullout"},
		{time = 9 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_harpoon_pullout_first"] = {
		{time = 13 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 6 / 30, type = "sound", value = "yurie_h1.hrpn_pullout_first"},
		{time = 29 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
	},
	["h1_wpn_melee_harpoon_putaway"] = {
		{time = 11 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 7 / 30, type = "sound", value = "yurie_h1.hrpn_putaway"},
	},
	["h1_wpn_melee_harpoon_stab"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.hrpn_stab"},
		{time = 5 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_harpoon_swipe"] = {
		{time = 2 / 30, type = "sound", value = "yurie_h1.hrpn_swipe"},
...
if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.hrpn_","weapons/tfa_cod/mwr/h1_dlc_wpn/melee_hrpn/h1_wpn_melee_hrpn_"
