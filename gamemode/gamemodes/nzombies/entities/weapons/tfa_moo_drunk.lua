...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_broken_bottle_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_broken_bottle_wm.mdl"
SWEP.HoldType = "knife"
...
SWEP.EventTable = {
	["h1_wpn_melee_broken_bottle_inspect"] = {
		{time = 13 / 30, type = "sound", value = "yurie_h1.bottle_insp_1"},
		{time = 20 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 36 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 52 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 69 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 33 / 30, type = "sound", value = "yurie_h1.bottle_insp_2"},
		{time = 46 / 30, type = "sound", value = "yurie_h1.bottle_insp_3"},
		{time = 65 / 30, type = "sound", value = "yurie_h1.bottle_insp_4"},
	},
	["h1_wpn_melee_broken_bottle_pullout"] = {
		{time = 0, type = "sound", value = "yurie_h1.bottle_pullout_quick"},
	},
	["h1_wpn_melee_broken_bottle_pullout_first"] = {
		{time = 15 / 30, type = "sound", value = "yurie_h1.bottle_pullout_first_start"},
		{time = 34 / 30, type = "sound", value = "yurie_h1.bottle_pullout_first_finish"},
		{time = 32 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_broken_bottle_putaway"] = {
		{time = 4 / 30, type = "sound", value = "yurie_h1.bottle_putaway"},
	},
	["h1_wpn_melee_broken_bottle_stab"] = {
		{time = 6 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_broken_bottle_swipe"] = {
...
SWEP.Secondary.Attacks = {
	{
		...
		["dmgtype"] = DMG_SLASH,
		["delay"] = 5 / 30,
		["snd"] = "yurie_h1.bottle_stab_start_02",
		["snd_delay"] = 1 / 30,
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_broken_bottle")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_broken_bottle", "vgui/killicons/tfa_mwr_broken_bottle", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.bottle_","weapons/tfa_cod/mwr/h1_dlc_wpn/bottle/bottle_"
	TFA.AddSound(p1.."insp_1", CHAN_STATIC, 1, 75, 100, p2.."insp_1.ogg", ")")
	TFA.AddSound(p1.."insp_2", CHAN_STATIC, 1, 75, 100, p2.."insp_2.ogg", ")")
	TFA.AddSound(p1.."insp_3", CHAN_STATIC, 1, 75, 100, p2.."insp_3.ogg", ")")
	TFA.AddSound(p1.."insp_4", CHAN_STATIC, 1, 75, 100, p2.."insp_4.ogg", ")")
	TFA.AddSound(p1.."pullout_first_finish", CHAN_STATIC, 1, 75, 100, p2.."pullout_first_finish.ogg", ")")
	TFA.AddSound(p1.."pullout_first_start", CHAN_STATIC, 1, 75, 100, p2.."pullout_first_start.ogg", ")")
	TFA.AddSound(p1.."pullout_quick", CHAN_STATIC, 1, 75, 100, p2.."pullout_quick.ogg", ")")
	TFA.AddSound(p1.."putaway", CHAN_STATIC, 1, 75, 100, p2.."putaway.ogg", ")")
	TFA.AddSound(p1.."stab_start_02", CHAN_STATIC, 1, 75, 100, p2.."stab_start_02.ogg", ")")
	TFA.AddSound(p1.."swipe", CHAN_STATIC, 1, 75, 100, {p2.."swipe_01.ogg",p2.."swipe_02.ogg"}, ")")
end
