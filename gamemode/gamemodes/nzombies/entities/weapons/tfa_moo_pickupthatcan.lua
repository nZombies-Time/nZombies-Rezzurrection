...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_baton_vm.mdl"
...
SWEP.EventTable = {
	["h1_wpn_melee_baton_inspect"] = {
		{time = 4 / 30, type = "sound", value = "yurie_h1.batn_ins_01"},
		{time = 45 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 133 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 56 / 30, type = "sound", value = "yurie_h1.batn_ins_02"},
		{time = 100 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 106 / 30, type = "sound", value = "yurie_h1.batn_ins_03"},
		{time = 159 / 30, type = "sound", value = "yurie_h1.batn_ins_04"},
	},
	["h1_wpn_melee_baton_pullout"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.shovel_pullout"},
		{time = 11 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_baton_pullout_first"] = {
		{time = 1 / 30, type = "sound", value = "yurie_h1.batn_pullout_first_01"},
		{time = 22 / 30, type = "sound", value = "yurie_h1.batn_pullout_first_02"},
		{time = 29 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 31 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_baton_putaway"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.shovel_putaway"},
		{time = 10 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_baton_stab"] = {
		{time = 5 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
		{time = 1 / 30, type = "sound", value = "yurie_h1.batn_stab"},
	...
	["h1_wpn_melee_baton_swipe"] = {
		{time = 3 / 30, type = "sound", value = "yurie_h1.batn_swipe"},
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_baton")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_baton", "vgui/killicons/tfa_mwr_baton", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.batn_","weapons/tfa_cod/mwr/h1_dlc_wpn/melee_batn/h1_wpn_melee_batn_"
