if SERVER then
	AddCSLuaFile("nz_grenaderpg.lua")
	SWEP.Weight			= 1
...
SWEP.ViewModel				= "models/nz_equipment/v_rpg40_soviet.mdl"
SWEP.WorldModel				= "models/weapons/w_rpg40.mdl"
SWEP.UseHands = true
SWEP.vModel = true
...
function SWEP:ThrowGrenade(force)
	...
	if SERVER then
		...
		if self.Owner:HasPerk("widowswine") then
			...
			nade = ents.Create("nz_rpg40_ww2_explosive")
		end
