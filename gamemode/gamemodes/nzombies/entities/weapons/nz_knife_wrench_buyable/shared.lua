...
SWEP.PrintName = "The Adjuster"
SWEP.Author		= "Laby" --Author Tooltip
SWEP.ViewModel = "models/weapons/bo3_melees/wrench/c_wrench_nz_buyable.mdl"
SWEP.WorldModel = "models/weapons/bo3_melees/wrench/w_wrench.mdl"
