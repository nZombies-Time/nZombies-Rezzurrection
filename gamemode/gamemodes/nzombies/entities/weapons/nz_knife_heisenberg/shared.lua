...
SWEP.PrintName = "Heisenberg's Masterpiece"
SWEP.Author		= "Laby" --Author Tooltip
SWEP.ViewModel = "models/weapons/bo3_melees/mace/c_heisenhammer.mdl"
SWEP.WorldModel = "models/weapons/bo3_melees/mace/karlheisenberg_hammer.mdl"
...
SWEP.Primary.Attacks = {
	...
	},
	{
		...
		['dmg'] = 1000, --This isn't overpowered enough, I swear!!
		["dmgtype"] = bit.bor(DMG_CLUB),  --DMG_SLASH,DMG_CRUSH, etc.
		["delay"] = 9 / 30, --Delay
		['snd_delay'] = 7 / 30,
		['spr'] = true, --Allow attack while sprinting?
