...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_sawtooth_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_sawtooth_wm.mdl"
SWEP.HoldType = "melee"
...
SWEP.EventTable = {
	["h1_wpn_melee_sawtooth_inspect"] = {
		{time = 8 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 38 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 58 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 80 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 101 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 135 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 16 / 30, type = "sound", value = "yurie_h1.sawt_ins_01"},
		{time = 20 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 42 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 62 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 84 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 37 / 30, type = "sound", value = "yurie_h1.sawt_ins_02"},
		{time = 100 / 30, type = "sound", value = "yurie_h1.sawt_ins_03"},
		{time = 137 / 30, type = "sound", value = "yurie_h1.sawt_ins_04"},
	},
	["h1_wpn_melee_sawtooth_pullout"] = {
		{time = 10 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_sawtooth_pullout_first"] = {
		{time = 12 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 27 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
	},
	["h1_wpn_melee_sawtooth_putaway"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.melee_putaway"},
	},
	["h1_wpn_melee_sawtooth_stab"] = {
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_sawtooth")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_sawtooth", "vgui/killicons/tfa_mwr_sawtooth", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.sawt_","weapons/tfa_cod/mwr/h1_dlc_wpn/melee_sawtooth/h1_wpn_melee_sawt_"
