...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_scimitar_scorpion_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_scimitar_scorpion_wm.mdl"
SWEP.HoldType = "melee"
...
SWEP.EventTable = {
	["h1_wpn_melee_scimtar_inspect"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.scimtar_inspect_1"},
		{time = 20 / 30, type = "sound", value = "yurie_h1.scimtar_inspect_2"},
		{time = 64 / 30, type = "sound", value = "yurie_h1.scimtar_inspect_3"},
		{time = 65 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_scimtar_pullout"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.scimtar_pullout"},
		{time = 6 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_scimtar_pullout_first"] = {
		{time = 1 / 30, type = "sound", value = "yurie_h1.scimtar_pullout_first_1"},
		{time = 13 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 27 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 20 / 30, type = "sound", value = "yurie_h1.scimtar_pullout_first_2"},
	},
	["h1_wpn_melee_scimtar_putaway"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.scimtar_putaway"},
		{time = 7 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_scimtar_stab"] = {
		{time = 5 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_scimtar_swipe"] = {
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_scimitar_scorpion")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_scimitar_scorpion", "vgui/killicons/tfa_mwr_scimitar_scorpion", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.scimtar_","weapons/tfa_cod/mwr/h1_dlc_wpn/scimitar/scimtar_"
	...
	TFA.AddSound(p1.."pullout", CHAN_STATIC, 1, 75, 100, p2.."pullout.ogg", ")")
