...
SWEP.Author = "FlamingFox & GhostlyMoo"
SWEP.Slot = 0
SWEP.PrintName = "Flint Knife"
...
SWEP.ViewModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_obsidian_knife_vm.mdl"
SWEP.WorldModel = "models/weapons/tfa_cod/mwr/wpn_h1_melee_obsidian_knife_wm.mdl"
SWEP.HoldType = "knife"
...
SWEP.EventTable = {
	["h1_wpn_melee_obsidian_knife_inspect"] = {
		{time = 21 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 111 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
		{time = 0 / 30, type = "sound", value = "yurie_h1.obknife_ins_01"},
		{time = 58 / 30, type = "sound", value = "yurie_h1.obknife_ins_02"},
		{time = 7 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 101 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 98 / 30, type = "sound", value = "yurie_h1.obknife_ins_03"},
	},
	["h1_wpn_melee_obsidian_knife_pullout"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.b_knife_pullout_quick"},
		{time = 2 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_obsidian_knife_pullout_first"] = {
		{time = 8 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
		{time = 9 / 30, type = "sound", value = "yurie_h1.obknife_pullout_first"},
		{time = 31 / 30, type = "sound", value = "yurie_h1.viewmodel_medium"},
	},
	["h1_wpn_melee_obsidian_knife_putaway"] = {
		{time = 0 / 30, type = "sound", value = "yurie_h1.b_knife_putaway"},
		{time = 11 / 30, type = "sound", value = "yurie_h1.viewmodel_small"},
	},
	["h1_wpn_melee_obsidian_knife_stab"] = {
		{time = 5 / 30, type = "sound", value = "yurie_h1.viewmodel_large"},
	},
	["h1_wpn_melee_obsidian_knife_swipe"] = {
...
if surface and surface.GetTextureID then
	SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/tfa_mwr_obsidian_knife")
end

if killicon and killicon.Add then
	killicon.Add("tfa_mwr_obsidian_knife", "vgui/killicons/tfa_mwr_obsidian_knife", Color(255, 80, 0, 191))
end

if TFA and TFA.AddSound then
	local p1,p2="yurie_h1.obknife_","weapons/tfa_cod/mwr/h1_dlc_wpn/melee_obknife/h1_wpn_melee_obknife_"
