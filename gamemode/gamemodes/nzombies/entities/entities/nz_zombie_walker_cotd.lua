...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t5/coast/moo_codz_t5_coast_barechest.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t5/coast/moo_codz_t5_coast_scuba.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t5/coast/moo_codz_t5_coast_soldier.mdl", Skin = 0, Bodygroups = {0,0}},
}
