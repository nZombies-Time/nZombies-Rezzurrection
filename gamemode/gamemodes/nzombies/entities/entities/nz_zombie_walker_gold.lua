...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t9/gold/moo_codz_t9_gold_shirtless_barbwire.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t9/gold/moo_codz_t9_gold_soldier_1.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t9/gold/moo_codz_t9_gold_shirtless_burnt.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t9/gold/moo_codz_t9_gold_omega_officer.mdl", Skin = 0, Bodygroups = {0,0}},
}
