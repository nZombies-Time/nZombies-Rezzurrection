...
if CLIENT then 
	ENT.EyeColorTable = {
		[0] = Material("models/moo/codz/t4_zombies/harrenhaus/mtl_c_ger_zombie_eyes.vmt"),
	}
	return 
...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t4/moo_codz_sethnorris_honorguard.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t4/moo_codz_sethnorris_honorguard.mdl", Skin = 1, Bodygroups = {0,0}},
	
	{Model = "models/moo/_codz_ports/t4/moo_codz_sethnorris_panzergren.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t4/moo_codz_sethnorris_panzergren.mdl", Skin = 0, Bodygroups = {0,0}},
}
