...
if CLIENT then 
	ENT.EyeColorTable = {
		[0] = Material("models/moo/codz/t7_stalingrad/mtl_c_zom_dlc3_sentinel_eyes.vmt"),
	}
	return 
...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t7/stalingrad/moo_codz_t7_sentinel_zombie.mdl", Skin = 0, Bodygroups = {0,0}},
}
