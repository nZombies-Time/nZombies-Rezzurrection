...
if CLIENT then 
	ENT.EyeColorTable = {
		[0] = Material("models/moo/codz/t6_greenrun/mtl_c_zom_zombie_head_a_unlit.vmt"),
		[1] = Material("models/moo/codz/t6_greenrun/mtl_c_zom_zombie_head_d_unlit.vmt"),
		[2] = Material("models/moo/codz/t6_greenrun/mtl_c_zom_zombie_head_f_unlit.vmt"),
		[3] = Material("models/moo/codz/t6_greenrun/mtl_c_zom_zombie_head_k_unlit.vmt"),
		[4] = Material("models/moo/codz/t6_greenrun/mtl_c_zom_zombie_head_l_unlit.vmt"),
		[5] = Material("models/moo/codz/t6_greenrun/mtl_c_zom_zombie_head_n_unlit.vmt"),
	}
	return 
...
ENT.Models = {
	...
	{Model = "models/moo/_codz_ports/t6/greenrun/moo_codz_t6_greenrun1.mdl", Skin = 1, Bodygroups = {0,0}},
	...
	{Model = "models/moo/_codz_ports/t6/greenrun/moo_codz_t6_greenrun5.mdl", Skin = 1, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/greenrun/moo_codz_t6_greenrun5.mdl", Skin = 2, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/greenrun/moo_codz_t6_greenrun6.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/greenrun/moo_codz_t6_greenrun6.mdl", Skin = 1, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/greenrun/moo_codz_t6_greenrun6.mdl", Skin = 2, Bodygroups = {0,0}},
}
