...
if CLIENT then 
	ENT.EyeColorTable = {
		[0] = Material("models/moo/codz/t6_zombies/tomb/mtl_c_zom_tomb_german_head_1_u.vmt"),
		[1] = Material("models/moo/codz/t6_zombies/tomb/mtl_c_zom_tomb_german_head_2_u.vmt"),
		[2] = Material("models/moo/codz/t6_zombies/tomb/mtl_c_zom_tomb_german_head_3_u.vmt"),
	}
	return 
...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t6/tomb/moo_codz_t6_tomb_soldier.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/tomb/moo_codz_t6_tomb_soldier.mdl", Skin = 1, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/tomb/moo_codz_t6_tomb_soldier.mdl", Skin = 2, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/tomb/moo_codz_t6_tomb_soldier.mdl", Skin = 3, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/tomb/moo_codz_t6_tomb_soldier.mdl", Skin = 4, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/tomb/moo_codz_t6_tomb_soldier.mdl", Skin = 5, Bodygroups = {0,0}},
}
