...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t7/genesis/moo_codz_t7_genesis_a-1.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t7/genesis/moo_codz_t7_genesis_a-2.mdl", Skin = 0, Bodygroups = {0,0}},
}
