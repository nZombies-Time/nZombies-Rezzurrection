...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t7/factory/moo_codz_t7_giant_a.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t7/factory/moo_codz_t7_giant_b.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t7/factory/moo_codz_t7_giant_c.mdl", Skin = 0, Bodygroups = {0,0}},
}
