...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t7/cosmodrome/moo_codz_t7_cosmodrome_cosmon.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t7/cosmodrome/moo_codz_t7_cosmodrome_spetz.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t7/cosmodrome/moo_codz_t7_cosmodrome_lab.mdl", Skin = 0, Bodygroups = {0,0}},
}
...
function ENT:OnSpawn()
	--if IsValid(self) then ParticleEffectAttach("bo3_zombie_eyeglow_red", 4, self, 3) end
	--if IsValid(self) then ParticleEffectAttach("bo3_zombie_eyeglow_red", 4, self, 4) end
	...
	local seq, dur = self:SelectSpawnSequence()
	if seq then
