...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t7/island/moo_codz_t7_island_a.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t7/island/moo_codz_t7_island_b.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t7/island/moo_codz_t7_island_c.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t7/island/moo_codz_t7_island_d.mdl", Skin = 0, Bodygroups = {0,0}},
}
...
local AttackSequences = {
	...
	{seq = "nz_legacy_jap_attack_v1", dmgtimes = {0.65}},
	{seq = "nz_legacy_jap_attack_v2", dmgtimes = {0.65}},
	{seq = "nz_legacy_jap_attack_v3", dmgtimes = {0.65, 1.00}},
	{seq = "nz_legacy_jap_attack_v4", dmgtimes = {0.60}},
	{seq = "nz_legacy_jap_attack_v5", dmgtimes = {0.50, 1.00}},
}
...
local RunAttackSequences = {
	{seq = "nz_legacy_jap_run_attack_v1", dmgtimes = {0.35}},
	{seq = "nz_legacy_jap_run_attack_v2", dmgtimes = {0.35}},
}
