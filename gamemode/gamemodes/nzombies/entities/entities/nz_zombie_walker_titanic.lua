...
ENT.Eye = Material("models/moo/codz/t8_zombies/common/mtl_c_t8_zmb_eyes.vmt")

ENT.Models = {
	{Model = "models/moo/_codz_ports/t8/titanic/moo_codz_t8_crew_officer.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t8/titanic/moo_codz_t8_crew_sailor.mdl", Skin = 0, Bodygroups = {0,0}},
	...
	{Model = "models/moo/_codz_ports/t8/mansion/moo_codz_t8_3rdclass_male_c.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t8/mansion/moo_codz_t8_3rdclass_male_c.mdl", Skin = 1, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t8/mansion/moo_codz_t8_3rdclass_male_c.mdl", Skin = 2, Bodygroups = {0,0}},
