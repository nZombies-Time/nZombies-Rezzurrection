...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t8/red_skeleton/moo_codz_t8_chaos_skelly.mdl", Skin = 0, Bodygroups = {0,0}},
}
...
function ENT:OnSpawn()
	--if IsValid(self) then ParticleEffectAttach("bo3_thrasher_aura", 4, self, 5) end
