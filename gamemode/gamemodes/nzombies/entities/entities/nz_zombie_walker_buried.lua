...
if CLIENT then 
	ENT.EyeColorTable = {
		[0] = Material("models/moo/codz/t6_buried/mtl_c_zom_buried_male_head1_u.vmt"),
		[1] = Material("models/moo/codz/t6_buried/mtl_c_zom_buried_male_head2_u.vmt"),
		[2] = Material("models/moo/codz/t6_buried/mtl_c_zom_buried_male_head3_u.vmt"),
		[3] = Material("models/moo/codz/t6_buried/mtl_c_zom_buried_saloongirl_head1_u.vmt"),
	}
	return 
