...
local runsounds = {
	Sound("nz_moo/zombies/vox/_proto/sprint/sprint_00.mp3"),
	Sound("nz_moo/zombies/vox/_proto/sprint/sprint_01.mp3"),
	Sound("nz_moo/zombies/vox/_proto/sprint/sprint_02.mp3"),
	Sound("nz_moo/zombies/vox/_proto/sprint/sprint_03.mp3"),
...
function ENT:Sound()
	...
	elseif self.BO4IsShocked and self:BO4IsShocked() or self.BO4IsScorped and self:BO4IsScorped() or self.BO4IsSpinning and self:BO4IsSpinning() then
		self:PlaySound(self.ElecSounds[math.random(#self.ElecSounds)],85, math.random(85, 105), 1, 2) -- Zappy Zappy Mother Trucker
	...
	elseif self:GetCrawler() then
		self:PlaySound(self.CrawlerSounds[math.random(#self.CrawlerSounds)],150, math.random(100, 105), 1, 2)
	elseif self.PassiveSounds then
		self:PlaySound(self.PassiveSounds[math.random(#self.PassiveSounds)],150, math.random(100, 105), 1, 2)
	else
