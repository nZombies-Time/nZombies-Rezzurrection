...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t7/sumpf/moo_codz_t7_dlchd_sumpf_a.mdl", Skin = 0, Bodygroups = {0,0}}, -- This model uses the CoD Skeleton.
...
local SprintAttackSequences = { -- Yes I know these are the same but its to make my life easier when it comes to mass changing the zombie luas.
	{seq = "nz_legacy_jap_run_attack_v1", dmgtimes = {0.35}},
	{seq = "nz_legacy_jap_run_attack_v2", dmgtimes = {0.35}},
}
