...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t9/silver/moo_codz_t9_silver_heavy_zombie.mdl", Skin = 0, Bodygroups = {0,0}},
}
...
function ENT:OnTakeDamage(dmginfo)
	...
	if resist[dmginfo:GetDamageType()] and !insta then
		if hitgroup == HITGROUP_HEAD then
			...
			self:EmitSound(self.MetalImp[math.random(#self.MetalImp)], 95, math.random(95,105))
		else
