...
if CLIENT then 
	ENT.EyeColorTable = {
		[0] = Material("models/moo/codz/t6_zombies/tomb/mtl_c_zom_tomb_crusader_head_1_u.vmt"),
		[1] = Material("models/moo/codz/t6_zombies/tomb/mtl_c_zom_tomb_crusader_head_z.vmt"),
		[2] = Material("models/moo/codz/t6_zombies/tomb/mtl_c_zom_tomb_crusader_head_z_u.vmt"),
	}
	return 
...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t6/tomb/moo_codz_t6_tomb_knight.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/tomb/moo_codz_t6_tomb_knight.mdl", Skin = 1, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/tomb/moo_codz_t6_tomb_templar.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t6/tomb/moo_codz_t6_tomb_templar.mdl", Skin = 0, Bodygroups = {0,0}},
}
