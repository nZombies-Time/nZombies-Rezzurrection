...
ENT.AttackSequences = {
	...
	{seq = "attack_big1", dmgtimes = {4.3,0.5,1.2,0.4}},
	{seq = "attack_grab_1", dmgtimes = {1.2}}
}
...
ENT.WalkSounds = {
	"re2/em7100/step1.mp3",
	"re2/em7100/step2.mp3"
}
...
self:EmitSound("re2/em7100/yell"..math.random(6)..".mp3")
end
