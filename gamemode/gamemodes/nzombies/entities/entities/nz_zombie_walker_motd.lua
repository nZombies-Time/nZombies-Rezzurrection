...
ENT.Models = {
	{Model = "models/moo/_codz_ports/t8/escape/moo_codz_t8_officer.mdl", Skin = 0, Bodygroups = {0,0}}, -- This model uses the CoD Skeleton.
	{Model = "models/moo/_codz_ports/t8/escape/moo_codz_t8_prisoner1.mdl", Skin = 0, Bodygroups = {0,0}},
	{Model = "models/moo/_codz_ports/t8/escape/moo_codz_t8_prisoner2.mdl", Skin = 0, Bodygroups = {0,0}},
}
