...
function EFFECT:Init( data )
	...
	sound.Play("nz/hellhound/spawn/strike.wav", self.StartPos, 100, 100, 1)
...
function EFFECT:Render()
	...
	render.DrawSprite( self.EndPos + Vector(0,0,30), math.random(100,400), math.random(100,400), Color(255,255,255,math.random(0,200)))
