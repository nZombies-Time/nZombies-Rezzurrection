...
nzPerks:NewPerk("fire", {
	...
	price = 3000,
	price_skin = 3000,
	desc = "Gain Burnout effect with a 20 second cooldown that increases after every use. Doubled fire damage. Take 0 burn damage.",
	desc2 ="Burnout cooldown reduced. Bullets randomly ignite enemies. Quadrupled fire damage.",
	material = 5,
...
nzPerks:NewPerk("death", {
	...
	model = "models/moo/_codz_ports_props/iw7/cp_town/soda_machine_01/moo_codz_iw7_cp_town_soda_machine_dp.mdl",
...
nzPerks:NewPerk("time", {
	...
	icon_bo2 = Material("nz_moo/icons/bo2/timeslip.png",	"smooth unlitgeneric"),
	...
	icon_soe = Material("perk_icons/soe/time.png", "smooth unlitgeneric"),
...
nzPerks:NewPerk("winters", {
	...
	price = 3000,
	price_skin = 3000,
	desc = "Taking damage with less than max health creates an Icestorm that slows and freezes nearby enemies.",
	desc2 = "Hold an additional charge, zombies slowed will never unthaw. need better ideas.",
	material = 28,
	wfz = "models/perk_bottle/c_perk_bottle_phd",
	...
	icon_mw = Material("perk_icons/mw/winter.png",	"smooth unlitgeneric"),
	...
	icon_soe = Material("perk_icons/soe/winter.png", "smooth unlitgeneric"),
