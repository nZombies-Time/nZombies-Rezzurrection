...
nzPerks:NewPerk("jugg", {
	...
	model = "models/perks/Tperks/juggernog/mc_mtl_p7_zm_vending_jugg.mdl",
...
nzPerks:NewPerk("gum", {
	...
	func = function(self, ply, machine)
		...
		if rand == 15 then
		for i, playr in ipairs( player.GetAll() ) do
		playr:ChatPrint( "Gas Zap Attack" )
		end
...
nzPerks:NewPerk("revive", {
	...
	model = "models/perks/Tperks/revivesoda/mc_mtl_p7_zm_vending_revive.mdl",
...
nzPerks:NewPerk("speed", {
	...
	model = "models/perks/Tperks/speedcola/mc_mtl_p7_zm_vending_speedcola.mdl",
...
nzPerks:NewPerk("mask", {
	...
	icon_bo2 = Material("perk_icons/bo4/mask.png", "smooth unlitgeneric"),
	icon_bo3 = Material("perk_icons/bo3/mask.png", "smooth unlitgeneric"),
	icon_bo4 = Material("perk_icons/bo4/mask.png", "smooth unlitgeneric"),
...
nzPerks:NewPerk("staminup", {
	...
	model = "models/perks/Tperks/staminup/mc_mtl_p7_zm_vending_marathon.mdl",
...
nzPerks:NewPerk("gin", {
	...
	model = "models/perks/Cperks/gin/gin.mdl",
	price = 2000,
	price_skin = 2000,
	...
	icon_bo3 = Material("perk_icons/bo3/gin.png", "smooth unlitgeneric"),
...
nzPerks:NewPerk("phd", {
	...
	icon_bo4 = Material("perk_icons/bo4/phd.png", "smooth unlitgeneric"),
...
nzPerks:NewPerk("deadshot", {
	...
	model = "models/perks/Tperks/deadshot/mc_mtl_p7_zm_vending_deadshot.mdl",
...
nzPerks:NewPerk("mulekick", {
	...
	model = "models/perks/Tperks/mulekick/mc_mtl_p7_zm_vending_mulekick.mdl",
...
nzPerks:NewPerk("pop", {
	...
	model_off = "models/perks/Cperks/chaos/chaos.mdl",
	...
	icon_bo3 = Material("perk_icons/bo3/pop.png", "smooth unlitgeneric"),
...
nzPerks:NewPerk("death", {
	...
	icon_waw = Material("perk_icons/death.png",		"smooth unlitgeneric"),
	icon_bo2 = Material("perk_icons/death.png",		"smooth unlitgeneric"),
	...
	icon_mw = Material("perk_icons/death.png",		"smooth unlitgeneric"),
...
nzPerks:NewPerk("tortoise", {
	...
	icon_waw = Material("perk_icons/tort.png",	"smooth unlitgeneric"),
	icon_bo2 = Material("perk_icons/tort.png",	"smooth unlitgeneric"),
	icon_bo3 = Material("perk_icons/bo3/tort.png",	"smooth unlitgeneric"),
	icon_bo4 = Material("perk_icons/bo4/tort.png",	"smooth unlitgeneric"),
	icon_mw = Material("perk_icons/tort.png",	"smooth unlitgeneric"),
	icon_cw = Material("perk_icons/bocw/tort.png",	"smooth unlitgeneric"),
	icon_dumb = Material("perk_icons/tort.png",	"smooth unlitgeneric"),
	icon_holo = Material("perk_icons/tort.png",	"smooth unlitgeneric"),
	icon_glow = Material("perk_icons/nobg/tort.png",	"smooth unlitgeneric"),
