...
nzPerks:NewPerk("mask", {
	...
	icon_bo2 = Material("perk_icons/bo4/mask.jpg", "smooth unlitgeneric"),
	icon_bo3 = Material("perk_icons/bo4/mask.jpg", "smooth unlitgeneric"),
...
nzPerks:NewPerk("death", {
	...
	icon_bo3 = Material("perk_icons/death.png",		"smooth unlitgeneric"),
	icon_bo4 = Material("perk_icons/death.png",		"smooth unlitgeneric"),
	icon_mw = Material("perk_icons/death.png",		"smooth unlitgeneric"),
	icon_cw = Material("perk_icons/death.png",		"smooth unlitgeneric"),
	icon_dumb = Material("perk_icons/death.png",	"smooth unlitgeneric"),
	icon_holo = Material("perk_icons/death.png",	"smooth unlitgeneric"),
	icon_glow = Material("perk_icons/death.png",	"smooth unlitgeneric"),
...
nzPerks:NewPerk("tortoise", {
	...
	icon_bo3 = Material("perk_icons/tort.png",	"smooth unlitgeneric"),
	icon_bo4 = Material("perk_icons/tort.png",	"smooth unlitgeneric"),
	icon_mw = Material("perk_icons/tort.png",	"smooth unlitgeneric"),
	icon_cw = Material("perk_icons/tort.png",	"smooth unlitgeneric"),
	icon_dumb = Material("perk_icons/tort.png",	"smooth unlitgeneric"),
	icon_holo = Material("perk_icons/tort.png",	"smooth unlitgeneric"),
	icon_glow = Material("perk_icons/tort.png",	"smooth unlitgeneric"),
