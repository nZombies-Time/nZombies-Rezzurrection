...
nzPerks:NewPerk("vigor", {
	...
	icon_cw = Material("perk_icons/cw/vigor.png", "smooth unlitgeneric"),
...
nzPerks:NewPerk("mulekick", {
	...
	icon_waw = Material("perk_icons/waw/mulekick.png", "smooth unlitgeneric"),
	icon_bo2 = Material("perk_icons/bo2/mulekick.png", "smooth unlitgeneric"),
	icon_bo3 = Material("perk_icons/bo3/mulekick.png", "smooth unlitgeneric"),
	icon_mw = Material("perk_icons/mw/mulekick.png", "smooth unlitgeneric"),
...
nzPerks:NewPerk("widowswine", {
	...
	icon_mw = Material("perk_icons/mw/widows.png", "smooth unlitgeneric"),
	icon_cw = Material("perk_icons/cw/widows.png", "smooth unlitgeneric"),
