...
nzPerks:NewPerk("dtap2", {
	...
	name_skin = "Bang Bangs",
	name_holo ="Seal Soda",
	model = "models/nzr/2022/machines/dtap2/vending_dtap2.mdl", -- i shitted
	skin = "models/perks/IWperks/bang/mc_mtl_p7_zm_vending_doubletap2.mdl",
	off_skin = 1,
	on_skin = 0,
	price = 2000,
...
nzPerks:NewPerk("speed", {
	...
	desc2 ="Drink perks faster. need more ideas. (WORK IN PROGRESS)",
	material = 15,
...
nzPerks:NewPerk("amish", {
	...
	price = 1000,
	price_skin = 1000,
	desc = "Repair barricades around you in a radius. Repairing barricades grants more points",
	desc2 = "need ideas.",
	material = 23,
...
nzPerks:NewPerk("revive", {
	...
	icon_dumb = Material("perk_icons/af/quack.png", "smooth unlitgeneric"),
...
nzPerks:NewPerk("fire", {
	...
	price = 3000,
	price_skin = 3000,
	desc = "Gain Burnout effect with a 40 second cooldown. Doubled fire damage. Take 0 burn damage (blocks health regeneration).",
	desc2 ="Burnout cooldown reduced to 20 seconds. Bullets randomly ignite enemies. Quadrupled fire damage.",
	material = 5,
...
nzPerks:NewPerk("mask", {
	...
	model = "models/perks/Cperks/mask/mask.mdl",
	model_off = "models/perks/Cperks/mask/mask.mdl",
	price = 1500,
	price_skin = 1500,
	desc = "Removes Novagas disorientation and damage (blocks health regeneration).",
	desc2 = "need ideas.",
	material = 8,
	wfz = "models/perk_bottle/c_perk_bottle_speed",
...
nzPerks:NewPerk("sake", {
	...
	price = 6000,
	price_skin = 6000,
	desc = "Permanently one shot zombies with your melee. Zombies electrify on death.",
	desc2 = "Zombies slain via melee proc PopShocks. (NOT IMPLEMENTED)",
	material = 14,
...
nzPerks:NewPerk("everclear", {
	...
	off_skin = 1,
	on_skin = 0,
	model_off = "models/perks/Cperks/everclear/everclear.mdl",
	model = "models/perks/Cperks/everclear/everclear.mdl",
	price = 2000,
	price_skin = 2000,
...
nzPerks:NewPerk("gin", {
	...
	desc2= "Keep all perks except gin after being revived.",
	material = 6,
...
nzPerks:NewPerk("tombstone", {
	...
	price = 2000,
	price_skin = 2000,
	desc = "Drop a Tombstone on down that you can retrieve to get everything back. Increased global bleedout time.",
	desc2 = "need ideas.",
	material = 22,
...
nzPerks:NewPerk("whoswho", {
	...
	price = 2000,
	price_skin = 2000,
	desc = "Randomly teleport away after taking fatal damage from a zombie. Damage is ignored.",
	desc2 = "need ideas.",
	material = 20,
...
nzPerks:NewPerk("pop", {
	...
	model = "models/perks/Cperks/chaos/chaos.mdl",
	price = 6000,
	price_skin = 6000,
	...
	icon_mw = Material("perk_icons/mw/epop.png", "smooth unlitgeneric"),
...
nzPerks:NewPerk("widowswine", {
	...
	desc2 = "Increased web explosion radius. Regain two grenades per widows drop.",
	material = 21,
...
nzPerks:NewPerk("death", {
	...
	material = 26,
	wfz = "models/perk_bottle/c_perk_bottle_danger",
	icon = Material("nz_moo/icons/cw/death.png",			"smooth unlitgeneric"),
	icon_iw = Material("nz_moo/icons/bo4/death.png",		"smooth unlitgeneric"),
	...
	icon_dumb = Material("nz_moo/icons/bo4/death.png",	"smooth unlitgeneric"),
	icon_holo = Material("nz_moo/icons/bo4/death.png",	"smooth unlitgeneric"),
...
nzPerks:NewPerk("tortoise", {
	...
	material = 25,
	wfz = "models/perk_bottle/c_perk_bottle_speed",
	icon = Material("nz_moo/icons/bo4/victor.png",		"smooth unlitgeneric"),
	icon_iw = Material("nz_moo/icons/bo4/victor.png",	"smooth unlitgeneric"),
	...
	icon_mw = Material("perk_icons/mw/tortoise.png",	"smooth unlitgeneric"),
	icon_cw = Material("nz_moo/icons/cw/victor.png",	"smooth unlitgeneric"),
	icon_dumb = Material("nz_moo/icons/bo4/victor.png",	"smooth unlitgeneric"),
	icon_holo = Material("nz_moo/icons/no background/victor.png",	"smooth unlitgeneric"),
