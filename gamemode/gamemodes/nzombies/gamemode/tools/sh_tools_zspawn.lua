nzTools:CreateTool("zspawn", {
	...
	PrimaryAttack = function(wep, ply, tr, data)
		...
		if IsValid(tr.Entity) and tr.Entity:GetClass() == "nz_spawn_zombie_normal" then
			...
			ent = nzMapping:ZedSpawn(tr.HitPos,(Angle(0,(ply:GetPos() - tr.HitPos):Angle()[2],0)), tobool(data.flag) and data.link or nil, tobool(data.master), data.spawntype, data.zombietype, data.roundactive, ply)
		end
