...
function MenuToolBar:Init()
	...
	self.Logo:SetFont("nz.main."..nzDisplay.GetFontType(nzMapping.Settings.mainfont))
...
function PlayerList:Paint(w, h)
	...
	for _,ply in pairs( player.GetAll() ) do
		if IsValid(ply) then
			...
			draw.SimpleText(ply:Nick() .. " - " .. text, ("nz.small."..nzDisplay.GetFontType(nzMapping.Settings.smallfont)), 25, h / 2 - n * 17.5 + 35 * c + 15, Color(255,255,255,255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
			c = c + 1
		end
	end
	return
